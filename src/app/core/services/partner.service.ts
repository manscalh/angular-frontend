...
export class PartnerService{
    private currentSubject = new BehaviorSubject<IPartner>({});
  
    private URL_API = environment.baseUrlBackend+"/partner";
    //private URL_API = "http://localhost:3000/partner";
  
    constructor(private httpClient: HttpClient, private router: Router, private authservice: AuthService) { }
  
    set(Partner: IPartner): void {
      this.currentSubject.next(Partner);
    }
    ...
    public save(obj: IPartner): Observable<any> {
    ...
    public edit(obj: IPartner): Observable<any> {

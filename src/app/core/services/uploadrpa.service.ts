...
import { IUploadRPA } from "../models";

@Injectable({
  providedIn: "root",
})
export class UploadRPAService {
  private currentSubject = new BehaviorSubject<IUploadRPA>({});

  private URL_API = environment.baseUrlBackend + "/uploadrpa";
  ...
  public save(obj: IUploadRPA): Observable<any> {
  ...
  public edit(obj: IUploadRPA): Observable<any> {
    return this.httpClient

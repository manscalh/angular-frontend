...
import { ICodeHistory } from "../models";
...
export class CodeHistoryService{
    private currentSubject = new BehaviorSubject<ICodeHistory>({});
  
    private URL_API = environment.baseUrlBackend+"/codehistory";
    //private URL_API = "http://localhost:3000/codehistory";

    constructor(private httpClient: HttpClient, private router: Router, private authservice: AuthService) { }
  
    set(CodeHistory: ICodeHistory): void {
      this.currentSubject.next(CodeHistory);
    }
    ...
    public save(obj: ICodeHistory): Observable<any> {
    ...
    public edit(obj: ICodeHistory): Observable<any> {

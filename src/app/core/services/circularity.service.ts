...
import { ICircularity } from "../models";
...
export class CircularityService{
    private currentSubject = new BehaviorSubject<ICircularity>({});
  
    private URL_API = environment.baseUrlBackend+"/circularity";
    
    constructor(private httpClient: HttpClient, private router: Router, private authservice: AuthService) { }
  
    set(Hardware: ICircularity): void {
    ...
    public save(obj: ICircularity): Observable<any> {
    ...
    public nextStep(obj: ICircularity): Observable<any> {
    ...
    public edit(obj: ICircularity): Observable<any> {
    ...
    public getGeneralCondition(): Observable<any> {
  
      return this.httpClient
        .get<any>(this.URL_API+"/GeneralCondition", { headers: this.getHeader })
        .pipe(
          delay(30),
          tap((res) => {

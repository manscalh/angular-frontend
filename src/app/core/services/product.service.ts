...
export class ProductService{
    private currentSubject = new BehaviorSubject<IProduct>({});
  
    private URL_API = environment.baseUrlBackend+"/product";
    
    constructor(private httpClient: HttpClient, private router: Router, private authservice: AuthService) { }
  
    set(Hardware: IProduct): void {
    ...
    public save(obj: IProduct): Observable<any> {
    ...
    public edit(obj: IProduct): Observable<any> {
    ...
    public getAllAutoComplete(filter: string): Observable<any> {
  
      return this.httpClient
        .get<any>(this.URL_API+"/AutoComplete?filter="+filter, { headers: this.getHeader })
        .pipe(
          delay(30),
          tap((res) => {

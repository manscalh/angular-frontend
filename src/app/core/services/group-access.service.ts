...
import { IGroupAccess } from "../models";
...
export class GroupAccessService{
    private currentSubject = new BehaviorSubject<IGroupAccess>({});
  
    private URL_API = environment.baseUrlBackend+"/group-access";
    
    constructor(private httpClient: HttpClient, private router: Router, private authservice: AuthService) { }
  
    set(Hardware: IGroupAccess): void {
    ...
    public save(obj: IGroupAccess): Observable<any> {
    ...
    public edit(obj: IGroupAccess): Observable<any> {

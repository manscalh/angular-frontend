...
@Component({
  selector: 'app-financial-economy',
  templateUrl: './financial-economy.component.html',
  styleUrls: ['./financial-economy.component.scss']
})
export class FinancialEconomyComponent implements OnInit {
  ...
  private createChart(): void {
    this.chart = Highcharts.chart('chart-finacial-economy', this.chartOptions);
  }
      ...
      const dataArray = Array.isArray(dados) ? dados : Object.values(dados);
        ...
        for (const key in dataArray) {
          if (dataArray.hasOwnProperty(key)) {
            ...
            somaSave += registro.package_cost;
          }
        }
        this.countValue = somaSave.toFixed(2); 
